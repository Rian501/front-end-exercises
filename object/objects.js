...
function changeObjState(objPath, thePropertyToChange, theNewValue){
  console.log('prop to change', thePropertyToChange);
  objPath[thePropertyToChange] = theNewValue;
};

changeObjState(voteURL, "TNvoters", "some.new.url");
