...
// console.log('customers???', customers); //this is an object.
console.log('customers???', customers.customers); //this is an array of objects

customers.customers.forEach(customer => {
  // console.log('customer indiv', customer);
  // console.log('customers contact info', customer.contacts);
  console.log('customers email address arr', customer.contacts.email);
})

let arrOfEmailArrs = customers.customers.map(customer => {
  return customer.contacts.email;
})

console.log('emailsarr?', arrOfEmailArrs);

let concattedArr = arrOfEmailArrs.reduce((buildingArr, nextArr) => {
  // console.log('current email arr', emailArr);
  return buildingArr.concat(nextArr);
})

console.log('concatted arr?', concattedArr);
